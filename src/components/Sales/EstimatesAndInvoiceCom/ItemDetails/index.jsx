  ...
  return (
    <div className="bg-[#f6f9fc] rounded w-full p-1 border border-[#ced4da] overflow-x-auto">
      <div className="table-responsive">
        <table className="w-full table-fixed border-collapse bg-white overflow-x-auto">
          <thead>
        ...
        <button
          onClick={addRow}
          className=" m-4 bg-[#437c94] text-white px-2 py-1 rounded-full hover:bg-[#1e3a8a] duration-500"
        >
          Add Row
        </button>
      </div>
